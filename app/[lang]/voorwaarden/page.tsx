...
import { homeHref, privacyHref, termsHref } from "@/lib/i18n/path";
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `${BASE_URL}${termsHref(lang, dict)}`,
      languages: {
        "nl-BE": `${BASE_URL}${termsHref("nl", getDictionary("nl"))}`,
        en: `${BASE_URL}${termsHref("en", getDictionary("en"))}`,
        "x-default": `${BASE_URL}${termsHref("nl", getDictionary("nl"))}`,
      },
    },
  };
}
    ...
    <article className="mx-auto max-w-3xl px-5 py-14 md:px-8 md:py-20">
      ...
      <div className="prose-privacy mt-10 space-y-10 text-base leading-relaxed text-forest-muted">
        <LegalSections
          ...
          inlineLink={{
            label: dict.terms.privacyLinkLabel,
            href: privacyHref(lang, dict),
          }}
        />
